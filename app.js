...
// game.push(Difficulty: ["Easy", "Med", "Hard"])
...
game.party.push(pokemon[149], pokemon[148], pokemon [144]);
...
// game.gyms.forEach((arr) => {
//     arr.difficulty.forEach((easyGym) => {
//         if (easyGym < 3) {
//             gym.completed = true;
//         }
//     })
...
pokemon.forEach(starterPoke => {
    if (starterPoke.starter) {
...
// game.catchPokemon({ number: 143, name: "Snorlax", type: "normal", hp: 160, starter: false })
...
// How can I do this all in one step?
